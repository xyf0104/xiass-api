...
.select-trigger {
  ...
  @apply rounded-xl px-4 py-3 text-base;
  @apply bg-white dark:bg-dark-800;
  @apply border border-gray-300 dark:border-dark-600;
  @apply text-gray-900 dark:text-gray-100;
  @apply transition-all duration-200;
  @apply focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/30;
  @apply hover:border-gray-400 dark:hover:border-dark-500;
...
.select-dropdown-portal .select-search-input {
  @apply flex-1 bg-transparent text-base;
  @apply text-gray-900 dark:text-gray-100;
...
.select-dropdown-portal .select-option {
  ...
  @apply rounded-xl border border-gray-200 dark:border-dark-700/60;
  @apply mb-2 last:mb-0;
  @apply hover:bg-gray-50/50 dark:hover:bg-dark-700/30 hover:border-primary-400 dark:hover:border-primary-500;
  pointer-events: auto !important;
}

.select-dropdown-portal .select-option-selected {
  @apply bg-primary-100/80 dark:bg-primary-950/60;
  @apply border-primary-500 dark:border-primary-400;
  @apply text-primary-900 dark:text-primary-100;
}

.select-dropdown-portal .select-option-focused {
  @apply bg-gray-50/80 dark:bg-dark-700/40;
}
...
.select-dropdown-portal .select-option-group {
  ...
  @apply border-none mb-1 mt-1 first:mt-0;
}
...
.select-dropdown-portal .select-option-label {
  @apply flex-1 min-w-0 truncate text-left font-semibold;
}

.select-dropdown-portal .select-empty {
  @apply px-4 py-8 text-center text-base;
