...
const GITHUB_REPO = 'xyf0104/nowind-api'
// GHCR image published by CI (tags carry no "v" prefix, e.g. ghcr.io/xyf0104/nowind-api:1.0.67)
const DOCKER_IMAGE = 'ghcr.io/xyf0104/nowind-api'
