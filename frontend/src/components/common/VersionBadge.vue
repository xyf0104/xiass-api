...
const GITHUB_REPO = 'xyf0104/xiass-api'
// GHCR image published by CI (tags carry no "v" prefix, e.g. ghcr.io/xyf0104/xiass-api:1.0.68)
const DOCKER_IMAGE = 'ghcr.io/xyf0104/xiass-api'
