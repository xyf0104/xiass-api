export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 NoWind API 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 NoWind API 端解除该限制。',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 NoWind API 实例的场景。',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 NoWind API 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 NoWind API 用户登录',
      ...
      site: {
        ...
        siteNamePlaceholder: 'NoWind API',
        siteSubtitle: '站点副标题',
      ...
      smtp: {
        ...
        fromName: '发件人名称',
        fromNamePlaceholder: 'NoWind API',
        useTls: '使用 TLS',
