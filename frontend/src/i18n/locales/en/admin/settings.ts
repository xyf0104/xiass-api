export default {
    executionNodes: {
      ...
      description: 'Join two XIASS installations into one account pool. Generate an invite on one machine, then enter the address and invite on the other; XIASS handles the rest.',
      ...
      smartRotationCooldownMinutes: '{count} min',
      smartRotationCooldownDay: '1440 min (24 hours)',
      modelPattern: 'Model',
      modelPatternPlaceholder: 'Choose or enter a model, for example gpt-5.6-luna',
      preferredAccounts: 'Preferred accounts',
      selectedAccounts: '{count} selected',
      configureAccounts: 'Configure accounts',
      configureModelAccounts: 'Preferred accounts for {model}',
      removeRule: 'Remove rule',
      addModelPriorityRule: 'Add model rule',
      noModelPriorityRules: 'No model priority rules are configured.',
      searchPriorityAccounts: 'Search account or email',
      allAccountPools: 'All account pools',
      allPlans: 'All plans',
      allExecutionNodes: 'All machines',
      availableAccounts: 'Currently schedulable',
      prioritySelectionSummary: '{filtered} filtered, {selected} selected',
      selectedAccountOrder: 'Priority order',
      missingPriorityAccount: 'Account #{id} (missing from catalog)',
      dragPriorityAccount: 'Drag to reorder {account}',
      movePriorityAccountUp: 'Move {account} up',
      movePriorityAccountDown: 'Move {account} down',
      selectFilteredAccounts: 'Select filtered results',
      deselectFilteredAccounts: 'Deselect filtered results',
      ...
      accountPool: 'Pool',
      accountPriority: 'Base priority',
      noMatchingAccounts: 'No OpenAI accounts match these filters.',
      applySelectedAccounts: 'Apply selection',
      modelPriorityLoadFailed: 'Failed to load model priority rules',
      modelPriorityAccountsLoadFailed: 'Failed to load account filters',
      modelPrioritySaveSuccess: 'Model priority scheduling saved',
      modelPrioritySaveFailed: 'Failed to save model priority scheduling',
      pairingTitle: 'Connect another machine',
      pairingDescription: 'Two steps are enough. XIASS checks the connection first and only joins after the checks pass.',
      pairingReady: 'Connected',
      pairingIncomplete: 'Connection is being completed',
      pairingNotPaired: 'Not connected',
      inviteTitle: 'Step 1: Generate an invite',
      inviteHint: 'Give the invite to the administrator of the other machine. It expires in 10 minutes, works once, and does not affect active customers.',
      generateInvite: 'Generate invite',
      initializeFirst: 'Prepare this machine first',
      regenerateInvite: 'Regenerate',
      copyInvite: 'Copy',
      inviteExpiry: 'Expires at {time}. The raw invite is not shown again after leaving this page.',
      noInvite: 'No invite has been generated. Generating one does not change routing or customer traffic.',
      joinTitle: 'Step 2: Enter the invite and connect',
      joinHint: 'Enter the address of the machine that generated the invite, then paste the invite. This machine is detected automatically.',
      inviteAuthorityNotice: 'Generate the invite on the machine with the complete customer and account data. The other machine will use that data.',
      joinAuthorityNotice: 'XIASS checks that this machine is empty before joining. A failed check leaves its data untouched.',
      peerURL: 'Invite source address',
      peerURLPlaceholder: 'Enter the other machine HTTPS address',
      targetNodeID: 'Target node ID',
      targetURL: 'Target public URL',
      targetURLPlaceholder: 'Filled automatically',
      inviteToken: 'One-time invite',
      pair: 'Connect',
      pairing: 'Connecting...',
      unpair: 'Disconnect',
      protocolCheck: 'Pairing protocol',
      databaseCheck: 'PostgreSQL',
      redisCheck: 'Redis',
      authCheck: 'Authentication keys',
      productionCheck: 'Production readiness',
      passed: 'Match',
      failed: 'Mismatch',
      pairingReadyHint: 'Connected. Both machines show the same administrators, customers, keys, balances, billing, and accounts. Each account still uses its own machine.',
      pairingMismatchHint: 'The connection is not finished. Shared use stays off and existing data is not overwritten.',
      pairingLoadFailed: 'Failed to load pairing status',
      pairingFailed: 'Connection failed',
      inviteGenerated: 'One-time invite generated',
      inviteCopied: 'Invite copied',
      inviteCopyFailed: 'Could not copy invite',
      pairSuccess: 'Connected',
      pairApplying: 'Verified. The connection is being completed; you will return to sign-in when the server is ready.',
      pairRecoveryTimeout: 'The server is taking longer to recover. Refresh later and sign in with an administrator from the invite source machine.',
      unpairSuccess: 'This machine connection record was removed',
      confirmUnpairTitle: 'Disconnect the machines?',
      confirmUnpairMessage: 'Disconnecting removes only this machine connection record. It does not delete accounts, keys, billing, or shared data. Turn off shared use first when possible.',
      confirmUnpair: 'Disconnect',
      refresh: 'Refresh',
      saving: 'Saving...',
      save: 'Save',
      enabled: 'Use both machines',
      enabledHint: 'New requests can use accounts from both machines. Each account still reaches its provider through its own machine.',
      on: 'Enabled',
      off: 'Disabled',
      runtimeTitle: 'Prepare this machine',
      initializeTitle: 'Prepare this machine first',
      initializeHint: 'Click once and XIASS handles the local setup. Shared use stays off while preparation runs.',
      machineName: 'Machine name (optional)',
      detectedMachine: 'This machine was detected automatically; no ID is needed',
      autoDetectedTarget: 'Detected automatically: {name}; address: {url}',
      currentPage: 'current page address',
      autoEgress: 'Managed automatically',
      egressReady: 'Machine egress ready',
      accountPathReady: 'Account access ready',
      accountPathInvalid: 'Account access not ready',
      nodeIDPlaceholder: 'for example api2',
      initialize: 'Start preparation',
      initializing: 'Preparing...',
      initializeAccepted: 'Local node initialization started. Refresh after the app is back.',
      initializeFailed: 'Machine preparation failed',
      localNode: 'This machine',
      otherNode: 'Other machine',
      ...
      database: 'PostgreSQL',
      redis: 'Redis / heartbeat',
      healthy: 'Healthy',
      unavailable: 'Unavailable',
      notRequired: 'Not enabled',
      nodesTitle: 'Usage share between machines',
      node: 'Machine',
      online: 'Online',
      offline: 'Offline',
      local: 'Local',
      weight: 'Traffic share',
      weightHint: 'For example, 3 and 1 means about 75% and 25%. Set 0 to stop new requests on a machine temporarily.',
      syncStatus: 'Synced to both machines · {time}',
      egress: 'Access path',
      egressHint: 'Accounts reach their provider through their own machine. XIASS handles this automatically.',
      proxyMissing: 'No egress configured',
      proxyInvalid: 'Egress unavailable',
      accounts: 'Accounts',
      activeAccounts: 'Active',
      schedulableAccounts: 'Available',
      addNode: 'Add node',
      removeNode: 'Remove node',
      ingressTitle: 'How customers connect',
      ingressDescription: 'Customers keep using the same address and Key. This ratio only controls how the two machines share accounts. Each account continues to use its owning machine and fixed egress for upstream requests.',
      canEnable: 'Checks passed; ready to turn on',
      cannotEnable: 'Not ready to turn on',
      confirmEnableTitle: 'Use accounts from both machines?',
      confirmEnableMessage: 'New requests will use accounts from both machines according to the saved ratio. Existing accounts and data are not deleted, and each account keeps its own machine path.',
      ...
      adminWritePaired: 'Shared pairing state verified: authenticated administrators have equal full management access on all paired nodes, independent of peer availability. Account ownership and fixed egress remain unchanged.',
      adminWritePairingUnavailable: 'Shared pairing state could not be verified. Writes are unavailable until the pairing protocol and shared state are verified.',
      adminWriteSecondary: 'This node does not yet have shared management access. Groups, prices, and other nodes\' accounts are read-only; shared usage ratios remain editable. Complete shared-state pairing verification for full management access.',
      sharedAccess: {
        readOnlyTitle: 'Shared configuration is read-only on this standby machine',
        readOnlyDescription: 'While the primary is online, groups, pricing, and accounts remain visible, but only local accounts can be managed. Usage ratios can still be changed under Load Balancing.',
        actionBlocked: 'The primary machine is online, so shared configuration is read-only here.'
      },
      noIssues: 'No configuration issues detected.',
      reloadFailed: 'Failed to load connection status',
      saveSuccess: 'Settings saved',
      saveFailed: 'Failed to save settings',
      invalidWeights: 'Check the usage ratios. At least one machine must have a ratio above 0.',
      invalidProxy: 'Connect both machines first so XIASS can start using their accounts.',
      issues: {
        MULTI_NODE_DISABLED: 'Shared use is off. This machine is running normally on its own.',
        EXECUTION_NODE_LOCAL_CONFIG_DISABLED: 'Prepare this machine before turning on shared use.',
        EXECUTION_NODE_RUNTIME_NODE_INVALID: 'This machine could not be identified. Prepare it again.',
        EXECUTION_NODE_RUNTIME_APPLIER_UNAVAILABLE: 'Automatic preparation requires a XIASS Docker installation.',
        EXECUTION_NODE_RUNTIME_PROXY_CONFLICT: 'This machine has conflicting connection information. Remove the old connection or prepare it again.',
        EXECUTION_NODE_RUNTIME_APPLY_FAILED: 'Machine preparation did not complete. The previous settings were restored.',
        EXECUTION_NODE_WEIGHTS_INVALID: 'The usage ratio is invalid. Check it before preparing this machine.',
        EXECUTION_NODE_PAIRING_TARGET_URL_REQUIRED: 'Open the admin page through this machine\'s HTTPS address.',
        EXECUTION_NODE_PAIRING_TARGET_URL_INVALID: 'This page address cannot be used. Open the admin page through HTTPS.',
        EXECUTION_NODE_PAIRING_ROUTING_INVALID: 'The two-machine connection is not ready. Try again shortly.',
        EXECUTION_NODE_PROXY_MAPPING_INCOMPLETE: 'The connection between the two machines is incomplete.',
        EXECUTION_NODE_PROXY_MAPPING_DUPLICATE_PROXY: 'The two machines cannot share the same access path. Prepare them again.',
        EXECUTION_NODE_PROXY_MAPPING_UNKNOWN_NODE: 'Machine connection information is inconsistent. Refresh and try again.',
        EXECUTION_NODE_PROXY_MAPPING_UNAVAILABLE: 'Machine connection information is unavailable. Finish the connection first.',
        INVALID_EXECUTION_NODE_PROXY_IDS: 'Machine connection information is invalid. Finish preparation first.',
        EXECUTION_NODE_LEGACY_PROXY_INVALID: 'The access path for existing accounts is unavailable.',
        EXECUTION_NODE_LOCAL_WEIGHT_MISSING: 'This machine has no usage ratio. Refresh and try again.',
        EXECUTION_NODE_LEGACY_WEIGHT_MISSING: 'Existing accounts have no usage ratio. Refresh and try again.',
        EXECUTION_NODE_LOCAL_PROXY_MISMATCH: 'This machine has inconsistent connection information. Prepare it again.',
        EXECUTION_NODE_LEGACY_PROXY_MISMATCH: 'Existing accounts have inconsistent connection information.',
        EXECUTION_NODE_PAIRING_NOT_READY: 'The two machines have not finished connecting.',
        EXECUTION_NODE_PREFLIGHT_UNAVAILABLE: 'Connection checks are temporarily unavailable. Try again shortly.',
        EXECUTION_NODE_PREFLIGHT_FAILED: 'Connection checks did not pass. Check both machines and try again.',
        EXECUTION_NODE_POLICY_UNAVAILABLE: 'Shared-use settings are temporarily unavailable.',
        EXECUTION_NODE_PROXY_REQUIRED: 'The machine access path is not ready. Finish the connection first.',
        EXECUTION_NODE_PROXY_IMMUTABLE: 'Machine access paths cannot be changed while shared use is on.',
        DATABASE_UNAVAILABLE: 'Shared data is temporarily unavailable.',
        SHARED_WEIGHTS_INVALID: 'The usage ratio is invalid.',
        SHARED_PROXY_MAPPING_INVALID: 'Machine connection information is invalid.',
        LOCAL_RUNTIME_DISABLED: 'Prepare this machine first.',
        LOCAL_NODE_ID_INVALID: 'This machine could not be identified. Prepare it again.',
        LOCAL_DEFAULT_PROXY_MISSING: 'This machine is not ready. Prepare it first.',
        LOCAL_WEIGHT_MISSING: 'This machine has no usage ratio. Refresh and try again.',
        LOCAL_PROXY_MISMATCH: 'This machine has inconsistent connection information.',
        LEGACY_OWNER_INVALID: 'Existing account connection information is incomplete.',
        LEGACY_PROXY_MISMATCH: 'Existing account connection information is inconsistent.',
        POSITIVE_WEIGHT_MISSING: 'At least one machine must have a usage ratio above 0.',
        PROXY_MAPPING_INVALID: 'Machine connection information is incomplete.',
    ...
    settings: {
      ...
      features: {
        ...
        modelPricing: {
          title: 'Model Pricing',
          description: 'Show logged-in users the existing XIASS model-price view, group multipliers, and CNY billing previews. Enabled by default.',
        ...
        availableChannels: {
          ...
          configureLink: 'Configure model channels in Channel Management > Channel Pricing',
          enabled: 'Enable Model Channels',
          enabledHint: 'When off, the Model Channels entry is hidden and the endpoint returns an empty list. Model Pricing remains independent.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for XIASS API end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for XIASS API end-user login',
      ...
      scheduling: {
        ...
        executionNodeBalancing: 'Use accounts from both machines',
        executionNodeBalancingHint: 'After connection, customers keep the same address and Key. New requests use accounts from both machines according to the saved ratio.',
        executionNodePanelHint: 'Connect the machines, check their status, set the usage ratio, and choose what happens during a disconnect here.',
        openExecutionNodePanel: 'Open connection page',
      ...
      gatewayForwarding: {
        ...
        grokCrossClientMapHint: 'Enabled by default. When disabled, GPT, Codex, o-series, and Claude model IDs are not silently rewritten to the default Grok text model.',
        grokDefaultBaseURLMode: 'Default Grok upstream',
        grokDefaultBaseURLModeHint: 'Used for Grok text requests only when the account has not explicitly enabled a custom base URL. Media and voice continue to use their respective official API hosts.',
      ...
      site: {
        ...
        teamChildCreation: 'Show Team Child Creation',
        teamChildCreationHint: 'The account entry is hidden by default. A valid Cloudflare mailbox configuration is required before enabling it.'
      },
      purchase: {
      ...
      payment: {
        ...
        rechargeBonusCampaign: 'Recharge Bonus Campaign',
        rechargeBonusCampaignHint: 'When disabled, new top-ups receive no campaign bonus; the existing recharge multiplier still applies. Rule changes apply only to orders created afterwards.',
        rechargeBonusThreshold: 'Top up at least',
        rechargeBonusGift: ', gift',
        rechargeBonusUnit: 'CNY',
        rechargeBonusAdd: 'Add bonus rule',
        rechargeBonusRemove: 'Remove bonus rule',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on XIASS API orders; the upstream type is sent as EasyPay type.',
