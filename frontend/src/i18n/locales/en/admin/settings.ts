export default {
    executionNodes: {
      ...
      ingressDescription: 'Customers keep using the same address and Key. This ratio only controls how the two machines share accounts. Using both domain names also requires separate domain health switching; this page does not change DNS.',
      ...
      sharedAccess: {
        ...
        takeoverTitle: 'Temporary management takeover is active',
        takeoverDescription: 'The primary is confirmed offline and takeover is enabled here. Shared configuration and peer accounts may be managed until the primary returns.',
      ...
      issues: {
        ...
        EMERGENCY_EGRESS_SETTING_INVALID: 'The temporary takeover setting is invalid. Save it again.',
