export default {
    settings: {
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on NoWind API orders; the upstream type is sent as EasyPay type.',
