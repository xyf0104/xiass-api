export default {
    ...
    groups: {
      ...
      userAccountAllowlist: {
        ...
        currentConcurrencyHint: 'Requests for this user that are still active in this group, including routing, waiting, and failover; the user rows sum to the group current value.',
        requests: 'requests',
