export default {
    ...
    users: {
      ...
      columns: {
        ...
        concurrency: 'Ingress Concurrency',
        status: 'Status',
      ...
      today: 'Today',
      total: 'Last 30d',
      usageScopeHint: 'Today and last-30-day charges for this user across all groups.',
      concurrencyScopeHint: 'Requests currently admitted into the system / user limit, including routing, waiting, and failover stages.',
      sortBy: 'Sort By',
    ...
    groups: {
      ...
      searchGroups: 'Search groups...',
      viewActiveConcurrencyAccounts: 'View current requests and accounts used in this group',
      ...
      usageToday: 'Today',
      usageTotal: 'Total',
      usageScopeHint: 'Today and total charges from all users in this group, not just users calling right now.',
      ...
      userAccountAllowlist: {
        ...
        searchPlaceholder: 'Search users in this group...',
        ...
        noSearchResults: 'No matching users in this group.',
        user: 'User',
        currentAccounts: 'Accounts in Use',
        currentConcurrency: 'Current Requests',
        currentConcurrencyHint: 'Requests still active for this user in the group. Counts after account names are occupied slots; Waiting for slot has not acquired an account slot yet. User rows sum to the group current value.',
        requests: 'requests',
        ...
        unavailableSelected: '{count} other selected accounts are temporarily unavailable',
        noSchedulableAccounts: 'This group has no configurable accounts.',
        allow: 'Allow',
        account: 'Account',
        status: 'Status',
        ...
        allowed: 'Allowed',
        denyAllAccounts: 'After saving, this user cannot call any account in this group.',
      ...
      form: {
        ...
        maxReasoningEffortHint: 'Limits explicit reasoning effort requests. For Composite groups, it applies only to requests resolved to OpenAI. Omitted effort stays omitted. The ceiling takes precedence over reasoning effort mappings.',
        ...
        reasoningEffortMappingsHint: 'Match models exactly, by prefix, or by suffix, and configure multiple request values in one scope. Leave model empty to match all models.',
        ...
        reasoningEffortModelPlaceholder: 'Leave empty for all models',
      ...
      videoPricing: {
        ...
        description:
          'Configure Grok video generation prices per second of output video. Leave empty to use the default rates (grok-imagine-video: ¥0.05/s 480p, ¥0.07/s 720p; video-1.5: ¥0.08/s 480p, ¥0.14/s 720p, ¥0.25/s 1080p).',
      ...
      modelPricing: {
		...
		basePrice: 'Base price × rate',
		finalPrice: 'Final CNY price',
      },
      voicePricing: {
      ...
      openaiLive: {
        ...
        hint: 'When enabled, API keys in this OpenAI group can create and control Live voice sessions. Disabled by default. The XIASS API server must run on Apple Silicon macOS with the official ChatGPT app installed; client platforms are unrestricted.',
        unsupportedTitle: 'Current server does not support Live',
        unsupportedMessage: 'This XIASS API server cannot generate the required Live attestation. Live will not work even if enabled. Continue anyway?',
