export default {
    ...
    groups: {
      ...
      userAccountAllowlist: {
        ...
        waitingForAccount: 'No account slot yet',
        waitingForAccountHint: 'Requests accepted by this group that do not currently hold an account slot, including selection, fast failover, and waits while the whole eligible pool is full.',
