export default {
    accounts: {
      ...
      pelicanBenchmark: {
        title: 'Pelican Benchmark',
        selectAll: 'Select All', startSelected: 'Test Selected ({count})', filter: 'Filter results', allResults: 'All', passed: 'Passed',
        continue: 'Continue', retry: 'Retry', busy: 'Processing, please wait...', waitingForExit: 'Stopping account tasks; waiting for them to exit before starting...',
        tabs: { new: 'New Test', current: 'Current Tests', history: 'Test History' },
        name: 'Account', plan: 'Plan', statusLabel: 'Status', model: 'Model', date: 'Test Date', duration: 'Duration', result: 'Actions / Result',
        count: '{count} items', seconds: '{seconds} s',
        startAll: 'Start All', start: 'Start Test', stopAll: 'Stop All', stop: 'Stop Test',
        refresh: 'Refresh', details: 'View Details', collapse: 'Collapse Details', preview: 'Test Result Preview', previous: 'Previous Page', next: 'Next Page',
        unavailable: 'Account unavailable, already testing, or selected model unsupported',
        empty: { new: 'No accounts available for testing', current: 'No current tests', history: 'No test history' },
        status: { queued: 'Starting', running: 'Running', canceling: 'Stopping, awaiting exit', succeeded: 'Completed', failed: 'Failed', canceled: 'Stopped', interrupted: 'Interrupted' },
        skipped: 'Skipped {count} unavailable or already testing accounts. Other requests were submitted.',
        partialStart: 'Some tests were submitted; later requests are unconfirmed. Refresh current tests to verify. Submitted tasks can still be stopped.',
        modelsFailed: 'Unable to load account models. Open the model options again to retry.',
        errors: {
          upstream_client_upgrade_required: 'Upstream requires a newer Codex client. Update compatibility settings before retrying.',
          continuation_source_unavailable: 'The original test record is temporarily unavailable. Retry later.',
          invalid_continuation_source: 'The original test cannot be continued. Create a new test.',
          upstream_http_400: 'Upstream rejected the request. Check model support before retrying.',
          upstream_http_401: 'Account authorization expired. Reauthorize before retrying.',
          upstream_http_403: 'Upstream access denied. Check account permissions.',
          upstream_http_404: 'Upstream model or service not found. Check model settings.',
          upstream_http_408: 'Upstream request timed out. Retry later.',
          upstream_http_429: 'Upstream rate or quota limit reached. Retry later.',
          upstream_http_500: 'Upstream service error. Retry later.',
          upstream_http_502: 'Upstream gateway error. Retry later.',
          upstream_http_503: 'Upstream service temporarily unavailable. Retry later.',
          upstream_http_504: 'Upstream gateway timed out. Retry later.',
          upstream_network_error: 'Unable to connect to upstream. Check the network before retrying.',
          upstream_stream_error: 'Upstream stream failed or was interrupted.',
          no_upstream_detail: 'No upstream error detail is available for safe display.',
          upstream_incomplete: 'Upstream response incomplete. Continue or retry.',
          account_unavailable: 'Account unavailable', ineligible: 'Account is not eligible', free_plan: 'Free accounts are excluded', unknown_plan: 'Plan not confirmed',
          unsupported_auth_mode: 'Authentication mode not supported', model_not_supported: 'Model not supported by this account', fixed_egress_unavailable: 'Fixed account egress unavailable',
          upstream_failed: 'Upstream test failed', html_too_large: 'Result exceeds size limit', invalid_html: 'Complete HTML was not returned', timeout: 'Test timed out',
          runner_interrupted: 'Test interrupted', runner_panic: 'Test execution failed', account_access_denied: 'Account management denied', account_not_found: 'Account not found', unknown: 'Test did not complete'
        },
        notConnected: 'The Pelican Benchmark service is not connected yet. Refresh after it is connected.',
        loadFailed: 'Unable to load test data. Refresh to retry.',
        startFailed: 'Start request not confirmed. Refresh current tests before retrying.',
        stopFailed: 'Stop request not confirmed. Refresh current tests before retrying.',
        stopWaitTimeout: 'Stopped waiting after 30 seconds. The original task has not been confirmed exited; no new test was created. You can still stop it, or refresh before retrying.',
        resultFailed: 'Unable to load the preview. Collapse and reopen to retry.'
      },
      ...
      activeConcurrencyFilter: '{group} · Accounts using concurrency now',
      clearActiveConcurrencyFilter: 'Show all accounts',
      ...
      dataExportedSkippedShadows: 'Data exported. Skipped {count} linked-credential account(s) (Spark shadows or OAuth copies): their scheduling config is not included in the backup; recreate and re-tune them after restore.',
      ...
      teamBusinessPlan: 'Team / Business',
      otherUnknownPlan: 'Other / Unknown plan',
      allLoginMethods: 'All login methods',
      password2FALogin: 'Password + 2FA',
      emailCodeLogin: 'Email verification code',
      loginMethodUnconfigured: 'Login details incomplete',
      allStatus: 'All Status',
      allGroups: 'All Groups',
      executionNodeAll: 'All ownership',
      executionNodeLocal: 'This machine',
      executionNodeReadOnlyBadge: 'Read only',
      executionNodeManageableBadge: 'Manageable',
      executionNodePairingUnavailable: 'Node pairing unavailable; account writes are paused',
      executionNodeBulkExcluded: '{count} read-only peer accounts were excluded.',
      executionNodeBulkRemoteReadOnly: 'The current filter contains read-only peer accounts and cannot be changed in bulk.',
      executionNodeRemoteReadOnly: '{node} accounts are managed by {node}; read-only here',
      executionNodeRemoteUnavailable: 'Remote account status is unavailable; read-only here',
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. XIASS API cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      duplicateOAuthSuccess: 'Account duplicated as "{name}" with shared OAuth credentials and inherited scheduling state.',
      ...
      syncUpstreamModelsMappingFallback: 'The upstream /models endpoint is unavailable. Capabilities were synchronized from the account\'s concrete model mappings.',
      syncUpstreamModelsMetadataPartial: 'Some model capabilities were saved. Remaining models will continue using conservative capability settings.',
      syncUpstreamModelsMetadataIncomplete: 'Model IDs were synchronized, but no complete verified capabilities were available. The existing capability snapshot was preserved.',
      syncUpstreamModelsMetadataTooLarge: 'The upstream model capabilities exceeded the safe storage limit. The existing capability snapshot was preserved.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another compatible gateway.',
    ...
    autoResetCredit: {
      title: 'Automatically use OpenAI reset credits',
      consent: 'Off by default. Enabling permits automatic use of existing credits, never purchases. Turning this off prevents new exchanges; sent exchanges still await their result.',
      threshold5h: '5h usage threshold (%)',
      threshold7d: '7d usage threshold (%)',
      pending: 'An exchange is running or unconfirmed. Repeat consumption is blocked; turning this off, refreshing or recovering account state will not unlock it. If it remains blocked, an administrator must verify the official exchange record before resolving it.',
      cooldown: 'Reset is cooling down. Retry shortly, within one minute. This is not an unconfirmed-result lock.',
      save: 'Save auto Reset settings',
      saved: 'Auto Reset settings saved',
      loadFailed: 'Settings unavailable or this node has no management access. Auto Reset cannot be edited.',
      saveFailed: 'Settings could not be saved. Reload to verify.',
      invalidThreshold: 'Usage thresholds must be between 0.1% and 100%.'
    },
      ...
      noProxy: 'No Proxy',
		multiProxy: {
			singleMode: 'Single proxy',
			multiMode: 'Multiple exits',
			configured: '{count} exits configured',
			distributionMode: 'Egress policy',
			balancedMode: 'Balanced',
			adaptiveMode: 'Adaptive priority',
			totalCapacity: 'Total capacity {count}',
			proxyCapacity: '{name} concurrency limit',
			routePriorityFor: '{name} route priority',
			routePriorityShort: 'Route priority',
			slots: 'slots',
			missingProxy: 'Proxy #{id} was deleted or is unavailable',
			remove: 'Remove exit'
		},
      systemManagedProxy: 'System Node Egress',
      systemManagedProxyAuto: 'Auto assigned',
      systemManagedProxyHint: 'This account belongs to {node} and defaults to that node\'s private egress. You can select another proxy without changing the account owner.',
      ...
      codexTicket: {
        viewStatus: 'View Codex Ticket',
        title: 'Account Codex Ticket',
        redactedNotice: 'Redacted status only; the raw ticket is hidden',
        accountEnabled: 'Enable ticket capture for this account',
        enabledHint: 'Enabled: this account may capture, refresh, and use tickets.',
        disabledHint: 'Off by default. Enable it before this account can capture or use tickets.',
        toggleFailed: 'Failed to update the account ticket setting. Please try again later.',
        captureProxyTitle: 'Capture Egress',
        captureProxyHint: 'Starting capture saves this selection for future manual and automatic captures. Business exits stay unchanged.',
        accountDefault: 'Automatic Capture Defaults',
        accountDefaultHint: 'Use saved capture exits; if none are saved, follow the business proxy defaults',
        allActive: 'All Active Proxies',
        allActiveHint: 'Capture through every currently active proxy',
        customProxies: 'Custom Proxies',
        customProxiesHint: 'Choose capture egresses by source and search',
        accountDefaultSummary: 'No dedicated exits are saved; automatic capture follows the business proxy defaults ({count} currently bound).',
        savedDefaultSummary: '{count} automatic capture exit(s) are saved.',
        savedUnknownWarning: '{count} saved exit ID(s) are deleted or not currently visible; they are retained by ID.',
        missingProxy: 'Exit ID {id} is deleted or not visible; it remains selected until you uncheck it.',
        followBusiness: 'Follow Business Exits',
        saveCaptureDefaults: 'Save Selection Only',
        savingCaptureDefaults: 'Saving...',
        captureDefaultsSaveFailed: 'Failed to save automatic capture exits. Please try again.',
        searchProxies: 'Search proxy, address, or source',
        allSources: 'All Sources',
        manualSource: 'Manual Proxy',
        selectAll: 'Select Visible',
        invert: 'Invert Visible',
        clear: 'Clear',
        proxySelectionSummary: '{count} capture exits selected.',
        proxyLoadFailed: 'Failed to load capture proxies. Please try again later.',
        ready: 'Captured (locally valid)',
        unavailable: 'Missing or expired',
        length: 'Length / upstream reference',
        shapeValid: 'Matches upstream reference shape',
        accountMode: 'Account mode',
        issuedAt: 'Issued at',
        expiresAt: 'Estimated local expiry',
        remaining: 'Remaining',
        remainingHours: '{hours}h {minutes}m',
        remainingMinutes: '{minutes}m',
        observedModel: 'Model returned during capture',
        egress: 'Ticket source egress',
        egressHint: 'The same account/model ticket is sent through the configured business exits. The capture result does not verify reuse on those exits; actual response models are recorded in request logs.',
        latency: 'Probe latency',
        fallbackHint: 'No target-model egress was found; using the fastest {model} ticket as fallback.',
        refresh: 'Re-fetch',
        refreshing: 'Fetching...',
        refreshFailed: 'Re-fetch failed. Please try again later.',
        probeDetails: 'View all egresses ({count})',
        unknownEgress: 'Unknown egress',
        blockedHint: 'The current fail-closed policy blocks requests without a valid ticket.',
        noStatus: 'No ticket status is available. The account may not have been harvested yet or may not be a Codex OAuth account.',
        storageHint: 'The raw ticket is stored in protected server-side account data for forwarding and refresh. It is never returned by account export, editing, or this management view.'
      },
