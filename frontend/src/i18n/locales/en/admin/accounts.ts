export default {
    accounts: {
      ...
      pelicanBenchmark: {
        ...
        status: { queued: 'Queued', running: 'Running', canceling: 'Stopping, awaiting exit', succeeded: 'Completed', failed: 'Failed', canceled: 'Stopped', interrupted: 'Interrupted' },
        ...
        errors: {
          ...
          upstream_stream_error: 'Upstream response interrupted. Retry the test.',
