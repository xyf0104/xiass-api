export default {
    accounts: {
      ...
      pelicanBenchmark: {
        ...
        status: { queued: 'Queued', running: 'Running', canceling: 'Stopping', succeeded: 'Completed', failed: 'Failed', canceled: 'Stopped', interrupted: 'Interrupted' },
      ...
      executionNodeTakeoverBadge: 'Taken over',
      ...
      executionNodeTakeoverRequired: '{node} is offline; enable emergency takeover before managing it',
