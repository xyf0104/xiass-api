    ...
    autoResetCredit: {
      ...
      noProxy: 'No Proxy',
		multiProxy: {
			...
			configured: 'Balanced · {count} exits configured',
      ...
      codexTicket: {
        ...
        captureProxyHint: 'This selects proxies for this Ticket capture only. It does not change the account’s normal proxy bindings.',
        accountDefault: 'Account Defaults',
        accountDefaultHint: 'Omit proxy_ids and preserve the existing backend behavior',
        ...
        accountDefaultSummary: 'This account currently exposes {count} bound egress(es); the backend default policy still decides the actual capture set.',
        ...
        clear: 'Clear',
        proxySelectionSummary: '{count} proxy_ids will be sent explicitly for this capture.',
        ...
        egressHint: 'Tickets are shared by account and model. This only records the capture source; normal requests can still use every proxy egress assigned to the account.',
