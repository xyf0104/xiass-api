export default {
    ops: {
      ...
      runtime: {
        ...
        slaMinPercent: 'Minimum SLA percentage',
        slaMinPercentHint: 'Shown in red below this value (default: 99.5%).',
        ttftP99MaxMs: 'Maximum TTFT P99 (ms)',
        ttftP99MaxMsHint: 'Shown in red above this value (default: 500ms).',
        requestErrorRateMaxPercent: 'Maximum request error rate (%)',
        requestErrorRateMaxPercentHint: 'Shown in red above this value (default: 5%).',
        upstreamErrorRateMaxPercent: 'Maximum upstream error rate (%)',
        upstreamErrorRateMaxPercentHint: 'Shown in red above this value (default: 5%).',
        silencing: {
