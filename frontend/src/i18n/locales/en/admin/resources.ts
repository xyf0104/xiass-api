export default {
    ...
    proxies: {
      ...
      tabs: {
        proxies: 'Proxy List',
        softRouter: 'Proxy Nodes',
        subscriptions: 'Subscription Nodes'
      },
      ...
      subscriptions: {
        ...
        sourcesHint: 'Supports Clash / Mihomo YAML, line-separated proxy URIs, and Base64 content. Merge up to 16 URL, pasted-text, or local-file sources through one server-side preview.',
        agentUnavailable: 'The XIASS proxy component is unavailable. Check the local proxy component before continuing.',
        preview: 'Preview Nodes',
        previewing: 'Parsing...',
        previewStale: 'A subscription source changed, so the previous preview snapshot is no longer valid. Preview again before applying.',
        refresh: 'Refresh Saved Sources',
        applying: 'Applying...',
        applyCount: 'Apply {count} Nodes',
        multiUrlLabel: 'Add Subscription URLs',
        multiUrlPlaceholder: 'One HTTPS subscription URL per line; duplicates are removed; maximum 16',
        addUrls: 'Add URLs',
        pasteContentLabel: 'Paste Node Content',
        addContent: 'Add Content',
        localFileLabel: 'Add Local Subscription Content',
        localFileHint: 'Choose YAML, TXT, URI, or Base64 content. File contents are never written to browser storage.',
        noSources: 'No subscription sources. Previewing and applying an empty list removes all saved subscriptions.',
        name: 'Name',
        defaultName: 'Subscription {index}',
        url: 'Subscription URL',
        content: 'Subscription Content',
        contentPlaceholder: 'Paste Clash / Mihomo YAML, line-separated URIs, or Base64 content',
        keepConfigured: 'Configured; leave empty to keep the existing value',
        userAgent: 'User-Agent (optional)',
        removeSource: 'Remove source',
        protocolFilter: 'Protocol filter (comma-separated; empty means all)',
        protocolPlaceholder: 'anytls, vless, vmess, trojan, hysteria2, ss',
        excludeKeywords: 'Excluded keywords (comma-separated)',
        excludePlaceholder: 'expired, plan, website',
        nodesTitle: 'Subscription Nodes',
        selectedSummary: '{selected} of {total} selected. This changes managed subscription proxies only and does not edit account bindings.',
        searchNodes: 'Search nodes or sources',
        ...
        source: 'Source',
        protocol: 'Protocol',
        xiassProxy: 'XIASS Proxy',
        createOnApply: 'Created on apply',
        previewFirst: 'Add subscription sources and select “Preview Nodes”.',
        lastSync: 'Last sync: {time}',
        destructiveTitle: 'Confirm Empty Subscription Selection',
        removeAllConfirm: 'The source list is empty. Imported proxies will not be deleted or disabled automatically. Remove them in IP management before detaching their subscription nodes.',
        disableAllConfirm: 'No nodes are selected. Imported proxies will not be disabled automatically. Remove them in IP management before detaching their subscription nodes.',
        destructiveConfirm: 'Apply Changes',
        sourceLimit: 'At most {count} subscription sources are supported',
        urlsAddedWithDuplicates: 'Added {added}; skipped {duplicate} duplicate URL(s)',
        duplicateContent: 'This node content has already been added',
        pastedContentTooLarge: 'Pasted content exceeds 2 MiB and was not added',
        fileTooLarge: '{name} exceeds 2 MiB and was not added',
        loadFailed: 'Failed to load subscription nodes',
        previewSuccess: 'Parsed {count} nodes',
        previewFailed: 'Failed to preview subscriptions',
        invalidUrl: 'Use a complete HTTPS subscription URL without a username or password. Add proxy URIs under node content; trailing #labels are ignored for subscription URLs.',
        allowInsecureTLS: 'Allow this subscription to skip node certificate verification (unsafe)',
        tlsConfirmTitle: 'Skip node certificate verification?',
        tlsConfirmMessage: 'Only nodes declaring skip-cert-verify in this subscription will skip verification, risking impersonation and man-in-the-middle attacks. Subscription downloads still verify HTTPS certificates. Other sources are unaffected. Enable only if you trust the provider.',
        insecureTLSRejected: 'This subscription contains nodes requesting skipped certificate verification. Fix their certificates, filter them out, or explicitly enable the per-source option after acknowledging the risk.',
        applySuccess: 'Applied {count} subscription nodes',
        applyFailed: 'Failed to apply subscription nodes',
        refreshSuccess: 'Saved subscriptions refreshed; unsaved edits were preserved',
        refreshFailed: 'Failed to refresh subscription nodes'
      },
    },
