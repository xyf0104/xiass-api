export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        checkModeQuotaHint: 'Only queries the linked account usage windows or balance',
        checkModeQuotaProbe: 'Probe + Quota',
        checkModeQuotaProbeHint: 'Probes the channel and attaches the account quota snapshot',
        linkedAccount: 'Linked Account',
        linkedAccountPlaceholder: 'Select an account',
        linkedAccountHint: 'Quota data comes from the selected account using the account-side usage query',
        linkedAccountEmpty: 'No accounts on this platform yet. Add one in Account Management first',
        linkedAccountMissing: 'The linked account no longer exists or is unavailable. Please select it again',
        openAIQuotaProbeHint: 'The OpenAI usage query may trigger a Codex probe that consumes account quota, at most once every 10 minutes',
    ...
    subscriptions: {
      ...
      bulk: {
        ...
        selectWindow: 'Select reset window',
        resetWindows: 'Reset selected windows',
        resetHint: 'Choose at least one usage window to reset.',
        extendHint: 'Enter the number of days to add. Positive values extend, negative values shorten.',
        groupFallback: 'Keep each subscription group',
        invalidDays: 'Enter a valid adjustment in the allowed range.',
        confirm: 'Apply the selected action to {count} subscriptions?',
        confirmTargets: 'Targets: {targets}',
        result: 'Completed: {success} succeeded, {failed} failed',
        itemFailed: '{user}: {reason}',
        requestFailed: 'The bulk request failed. Retry the failed items.',
        retry: 'Retry failed',
        retryHint: 'Only failed items will be retried.',
        selectionHint: 'Select at least one subscription.',
        selectionLimit: 'Select no more than {max} subscriptions at a time.',
