export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send traffic through your XIASS API Grok group.',
        claudeDescription: 'Configure Claude Code to use the Grok Anthropic Messages compatibility endpoint through your XIASS API Grok group.',
        ...
        claudeNote: 'These variables apply to the current terminal session. Merge them into your shell profile and ~/.claude/settings.json for persistent use.',
  ...
  usage: {
    ...
    outputSpeedNonStream: 'non-stream',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
  ...
  redeem: {
    ...
    historyLoadFailed: 'Failed to load redemption history. Please try again.',
