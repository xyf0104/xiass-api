export default {
    ...
    channels: {
      ...
      noGroupsSelected: '{platform} 尚未选择分组',
      emptyModelsInPricing: '{platform} 的定价配置中存在未选择模型的条目',
      ...
      form: {
        ...
        billingModelSourceResponse: '以上游响应模型计费',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        checkModeQuota: '配额',
        checkModeQuotaHint: '只查询关联账号的用量窗口或余额，不发送探活请求',
        checkModeQuotaProbe: '探活 + 配额',
        checkModeQuotaProbeHint: '探活的同时查询账号配额，并附加最新用量快照',
        linkedAccount: '关联账号',
        linkedAccountPlaceholder: '选择账号',
        linkedAccountHint: '配额数据来自所选账号，复用账号管理侧的用量查询',
        linkedAccountEmpty: '当前平台暂无账号，请先在账号管理中添加',
        linkedAccountMissing: '关联账号已不存在或不可访问，请重新选择',
        openAIQuotaProbeHint: 'OpenAI 用量查询可能触发 Codex 探测请求并消耗账号额度，每 10 分钟最多一次',
        apiMode: 'OpenAI 协议',
    ...
    subscriptions: {
      ...
      bulk: {
        ...
        selectWindow: '选择重置窗口',
        resetWindows: '重置所选窗口',
        resetHint: '请至少选择一个需要重置的用量窗口。',
        extendHint: '输入调整天数，正数延长，负数缩短。',
        groupFallback: '保留各自订阅分组',
        invalidDays: '请输入范围内有效的调整天数。',
        confirm: '确定对已选的 {count} 条订阅执行此操作吗？',
        confirmTargets: '目标：{targets}',
        result: '处理完成：成功 {success} 条，失败 {failed} 条',
        itemFailed: '{user}：{reason}',
        requestFailed: '批量请求失败，请重试失败项。',
        retry: '重试失败项',
        retryHint: '只会重试失败项。',
        selectionHint: '请至少选择一条订阅。',
        selectionLimit: '一次最多选择 {max} 条订阅。',
