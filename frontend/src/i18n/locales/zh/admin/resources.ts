export default {
    ...
    proxies: {
      ...
      subscriptions: {
        sourcesTitle: '订阅来源',
        sourcesHint: '支持 Clash / Mihomo YAML、逐行代理 URI 和 Base64 内容。最多融合 16 个 URL、粘贴文本或本地文件来源，由服务端统一预览。',
        agentUnavailable: 'XIASS 代理组件当前不可用，请先检查本地代理组件状态。',
        preview: '预览节点',
        previewing: '解析中...',
        previewStale: '订阅来源已更改，旧预览快照已作废。请重新预览后再应用。',
        refresh: '刷新已保存订阅',
        applying: '应用中...',
        applyCount: '应用 {count} 个节点',
        multiUrlLabel: '批量添加订阅 URL',
        multiUrlPlaceholder: '每行一个 HTTPS 订阅 URL，自动去重，最多 16 条',
        addUrls: '添加 URL',
        pasteContentLabel: '粘贴节点内容',
        addContent: '添加内容',
        localFileLabel: '添加本地订阅内容',
        localFileHint: '选择 YAML、TXT、URI 或 Base64 内容文件；文件内容不会写入浏览器存储。',
        noSources: '暂无订阅来源。保持为空并预览、应用，可删除全部已保存订阅。',
        name: '名称',
        defaultName: '订阅 {index}',
        url: '订阅链接',
        content: '订阅内容',
        contentPlaceholder: '粘贴 Clash / Mihomo YAML、逐行 URI 或 Base64 内容',
        keepConfigured: '已配置；留空保留原值',
        userAgent: 'User-Agent（可选）',
        removeSource: '删除来源',
        protocolFilter: '协议筛选（逗号分隔，留空为全部）',
        protocolPlaceholder: 'anytls, vless, vmess, trojan, hysteria2, ss',
        excludeKeywords: '排除关键词（逗号分隔）',
        excludePlaceholder: '过期, 套餐, 官网',
        nodesTitle: '订阅节点',
        selectedSummary: '已选择 {selected} / {total}。选择仅影响订阅托管代理，不会修改账号绑定。',
        searchNodes: '搜索节点或来源',
        allSources: '全部来源',
        allProtocols: '全部协议',
        selectAll: '全选当前',
        ...
        xiassProxy: 'XIASS 代理',
        createOnApply: '应用后创建',
        previewFirst: '添加订阅来源并点击“预览节点”。',
        lastSync: '上次同步：{time}',
        destructiveTitle: '确认清空订阅选择',
        removeAllConfirm: '当前来源列表为空。已导入的代理不会自动删除或停用；请先在 IP 管理中删除对应代理，再解除订阅托管。',
        disableAllConfirm: '当前没有选择任何节点。已导入的代理不会自动停用；请先在 IP 管理中删除对应代理，再解除订阅托管。',
        destructiveConfirm: '确认应用',
        sourceLimit: '最多支持 {count} 个订阅来源',
        urlsAddedWithDuplicates: '已添加 {added} 条，跳过 {duplicate} 条重复 URL',
        duplicateContent: '该节点内容已经添加',
        pastedContentTooLarge: '粘贴内容超过 2 MiB，未添加',
        fileTooLarge: '文件 {name} 超过 2 MiB，未添加',
        loadFailed: '加载订阅节点失败',
        previewSuccess: '已解析 {count} 个节点',
        previewFailed: '订阅解析失败',
        invalidUrl: '请输入完整 HTTPS 订阅地址，不要包含用户名或密码。节点 URI 请填入“粘贴节点内容”；链接末尾的 #备注支持自动忽略。',
        allowInsecureTLS: '允许此订阅跳过节点证书校验（有风险）',
        tlsConfirmTitle: '允许跳过节点证书校验？',
        tlsConfirmMessage: '仅此订阅内声明 skip-cert-verify 的节点会跳过证书校验，存在被冒充和中间人攻击的风险。订阅下载仍校验 HTTPS 证书，其他订阅不受影响。仅在信任节点提供方时启用。',
        insecureTLSRejected: '此订阅包含要求跳过证书校验的节点。请修复节点证书、筛选其他节点，或在确认风险后开启该订阅的“允许跳过节点证书校验”。',
        applySuccess: '已应用 {count} 个订阅节点',
        applyFailed: '应用订阅节点失败',
        refreshSuccess: '已刷新保存的订阅；未保存编辑仍保留',
        refreshFailed: '刷新订阅节点失败'
      },
    },
