export default {
    executionNodes: {
      title: '两台机器一键连接',
      description: '把两台 XIASS 合成一个账号池。先在一台机器生成邀请码，再在另一台输入地址和邀请码，系统会自动完成连接。',
      ...
      smartRotationCooldownMinutes: '{count} 分钟',
      smartRotationCooldownDay: '1440 分钟（24 小时）',
      modelPattern: '模型',
      modelPatternPlaceholder: '选择或输入模型，例如 gpt-5.6-luna',
      preferredAccounts: '优先账号',
      selectedAccounts: '已选 {count} 个',
      configureAccounts: '配置账号',
      configureModelAccounts: '配置 {model} 的优先账号',
      removeRule: '删除规则',
      addModelPriorityRule: '添加模型规则',
      noModelPriorityRules: '暂未配置模型优先规则。',
      searchPriorityAccounts: '搜索账号或邮箱',
      allAccountPools: '全部号池',
      allPlans: '全部订阅类型',
      allExecutionNodes: '全部机器',
      availableAccounts: '当前可调度',
      prioritySelectionSummary: '筛选结果 {filtered} 个，已选择 {selected} 个',
      selectedAccountOrder: '优先顺序',
      missingPriorityAccount: '账号 #{id}（目录中不存在）',
      dragPriorityAccount: '拖动调整 {account} 的优先顺序',
      movePriorityAccountUp: '上移 {account}',
      movePriorityAccountDown: '下移 {account}',
      selectFilteredAccounts: '全选筛选结果',
      deselectFilteredAccounts: '取消筛选结果',
      ...
      accountGroups: '分组',
      accountPool: '号池',
      accountPriority: '原优先级',
      noMatchingAccounts: '没有符合当前筛选条件的 OpenAI 账号。',
      applySelectedAccounts: '应用选择',
      modelPriorityLoadFailed: '模型优先规则加载失败',
      modelPriorityAccountsLoadFailed: '账号筛选数据加载失败',
      modelPrioritySaveSuccess: '模型优先调度已保存',
      modelPrioritySaveFailed: '模型优先调度保存失败',
      pairingTitle: '连接另一台机器',
      pairingDescription: '两步完成连接。系统会先检查，检查通过后才会接入，不会直接覆盖数据。',
      pairingReady: '已连接',
      pairingIncomplete: '正在完成连接',
      pairingNotPaired: '还没有连接',
      inviteTitle: '第一步：生成邀请码',
      inviteHint: '把邀请码交给另一台机器的管理员。邀请码 10 分钟内有效，只能使用一次，不会影响正在使用的客户。',
      generateInvite: '生成邀请码',
      initializeFirst: '请先准备本机',
      regenerateInvite: '重新生成',
      copyInvite: '复制',
      inviteExpiry: '有效期至 {time}；关闭页面后不会再次显示原始邀请码。',
      noInvite: '尚未生成邀请码。生成操作不会修改调度或客户流量。',
      joinTitle: '第二步：输入邀请码并连接',
      joinHint: '填写生成邀请码的那台机器地址，再粘贴邀请码。当前机器的信息会自动识别。',
      inviteAuthorityNotice: '建议在账号和客户资料完整的机器上生成邀请码，另一台机器会使用这些资料。',
      joinAuthorityNotice: '连接前会检查这台机器是否为空。检查通过后才会接入，原有数据不会被覆盖。',
      peerURL: '生成邀请码的机器地址',
      peerURLPlaceholder: '例如输入另一台机器的 HTTPS 地址',
      targetNodeID: '本机名称',
      targetURL: '本机地址',
      targetURLPlaceholder: '系统自动填写',
      inviteToken: '一次性邀请码',
      pair: '开始连接',
      pairing: '正在连接...',
      unpair: '断开连接',
      ...
      redisCheck: 'Redis',
      authCheck: '鉴权密钥',
      productionCheck: '生产就绪',
      passed: '一致',
      failed: '不一致',
      pairingReadyHint: '连接完成。两台机器会看到相同的管理员、客户、Key、余额、账单和账号；账号仍从自己的机器访问上游。',
      pairingMismatchHint: '连接还没有完成。系统不会提前打开共同使用，也不会覆盖原有数据。',
      pairingLoadFailed: '连接状态加载失败',
      pairingFailed: '连接失败',
      inviteGenerated: '一次性邀请码已生成',
      inviteCopied: '邀请码已复制',
      inviteCopyFailed: '无法复制邀请码',
      pairSuccess: '连接成功',
      pairApplying: '已验证，正在完成连接；服务器恢复后会自动返回登录页。',
      pairRecoveryTimeout: '服务器恢复时间较长，请稍后刷新页面并使用邀请码来源机器的管理员账号登录。',
      unpairSuccess: '已断开本机连接记录',
      confirmUnpairTitle: '确认断开连接',
      confirmUnpairMessage: '断开只删除本机的连接记录，不会删除账号、Key、账单或共享数据。建议先关闭共同使用。',
      confirmUnpair: '确认断开',
      refresh: '刷新',
      saving: '保存中...',
      save: '保存',
      enabled: '共同使用账号',
      enabledHint: '打开后，两台机器会一起为新请求选择可用账号；每个账号仍从所属机器访问上游。',
      on: '已启用',
      off: '未启用',
      runtimeTitle: '准备这台机器',
      initializeTitle: '先准备好这台机器',
      initializeHint: '只需点击一次，系统会自动完成本机设置。准备期间不会打开共同使用。',
      machineName: '机器名称（可不改）',
      detectedMachine: '已自动识别本机，无需填写编号',
      autoDetectedTarget: '当前机器已自动识别：{name}；使用地址：{url}',
      currentPage: '当前网页地址',
      autoEgress: '系统自动管理',
      egressReady: '本机出口正常',
      accountPathReady: '账号访问正常',
      accountPathInvalid: '账号访问未准备好',
      nodeIDPlaceholder: '例如 api2',
      initialize: '开始准备',
      initializing: '正在准备...',
      initializeAccepted: '本机准备已开始，应用恢复后请刷新本页。',
      initializeFailed: '本机准备失败',
      localNode: '本机',
      otherNode: '另一台机器',
      ...
      unavailable: '不可用',
      notRequired: '未启用',
      nodesTitle: '两台机器的使用比例',
      node: '机器',
      online: '在线',
      offline: '离线',
      local: '本机',
      weight: '使用比例',
      weightHint: '例如填 3 和 1，大约就是 75% 和 25%。填 0 可暂时停用某台机器接收新请求。',
      syncStatus: '已同步至两台机器 · {time}',
      egress: '访问方式',
      egressHint: '账号会从所属机器访问上游，系统自动处理。',
      proxyMissing: '未配置出口',
      proxyInvalid: '出口不可用',
      accounts: '账号',
      activeAccounts: '活跃',
      schedulableAccounts: '可用',
      addNode: '添加节点',
      removeNode: '移除节点',
      ingressTitle: '客户怎么访问',
      ingressDescription: '客户继续使用原来的地址和 Key。这里的比例只决定两台机器如何使用账号，每个账号仍通过所属机器的固定出口访问上游。',
      canEnable: '检查通过，可以打开',
      cannotEnable: '还不能打开',
      confirmEnableTitle: '确认开始共同使用账号',
      confirmEnableMessage: '打开后，新请求会按比例使用两台机器上的账号。原有账号和数据不会被删除，每个账号仍通过自己的机器访问上游。',
      confirmEnable: '确认打开',
      issueTitle: '需要处理的问题',
      statusTitle: '当前状态',
      adminWritePrimary: '当前是主机器，可以管理分组、定价和本机账号；两台机器都可以修改共同使用比例。',
      adminWritePaired: '共享配对状态验证通过：所有已配对节点上的认证管理员拥有相同完整管理权限，不依赖对方在线；账号归属与固定出口保持不变。',
      adminWritePairingUnavailable: '共享配对状态未能通过验证，暂不可写入。请检查配对协议与共享状态。',
      adminWriteSecondary: '当前节点尚未取得共享管理权限：分组、定价和其他节点账号只读，共同使用比例仍可调整。请完成共享状态配对验证以取得完整管理权限。',
      sharedAccess: {
        readOnlyTitle: '当前是备用机器，共享配置只读',
        readOnlyDescription: '主机器在线时可以查看分组、定价和账号，但只能管理本机账号。两台机器的使用比例仍可在“负载均衡”中调整。',
        actionBlocked: '主机器在线，当前备用机器只能查看共享配置。'
      },
      noIssues: '当前没有检测到配置问题。',
      reloadFailed: '连接状态加载失败',
      saveSuccess: '设置已保存',
      saveFailed: '设置保存失败',
      invalidWeights: '请检查使用比例，至少一台机器的比例要大于 0。',
      invalidProxy: '请先完成两台机器的连接，系统才能开始共同使用账号。',
      issues: {
        MULTI_NODE_DISABLED: '还没有打开共同使用，当前仍按单机运行。',
        EXECUTION_NODE_LOCAL_CONFIG_DISABLED: '请先准备本机，再打开共同使用。',
        EXECUTION_NODE_RUNTIME_NODE_INVALID: '本机识别失败，请重新准备本机。',
        EXECUTION_NODE_RUNTIME_APPLIER_UNAVAILABLE: '当前安装方式无法自动准备，请使用 XIASS Docker 安装。',
        EXECUTION_NODE_RUNTIME_PROXY_CONFLICT: '本机已有重复的连接信息，请先解除旧连接或重新准备。',
        EXECUTION_NODE_RUNTIME_APPLY_FAILED: '本机准备没有完成，原配置已恢复。',
        EXECUTION_NODE_WEIGHTS_INVALID: '使用比例无效，请检查后再准备。',
        EXECUTION_NODE_PAIRING_TARGET_URL_REQUIRED: '当前页面地址无法识别，请用机器的 HTTPS 地址打开后台。',
        EXECUTION_NODE_PAIRING_TARGET_URL_INVALID: '当前页面地址不可用，请用 HTTPS 地址打开后台。',
        EXECUTION_NODE_PAIRING_ROUTING_INVALID: '两台机器的连接信息没有准备好，请稍后重试。',
        EXECUTION_NODE_PROXY_MAPPING_INCOMPLETE: '两台机器的访问方式没有准备完整，请先完成连接。',
        EXECUTION_NODE_PROXY_MAPPING_DUPLICATE_PROXY: '两台机器不能共用同一个访问方式，请重新准备。',
        EXECUTION_NODE_PROXY_MAPPING_UNKNOWN_NODE: '机器连接信息不一致，请刷新后重试。',
        EXECUTION_NODE_PROXY_MAPPING_UNAVAILABLE: '机器连接信息不可用，请先完成准备。',
        INVALID_EXECUTION_NODE_PROXY_IDS: '机器连接信息无效，请先完成准备。',
        EXECUTION_NODE_LEGACY_PROXY_INVALID: '已有账号的访问方式不可用，请先检查连接。',
        EXECUTION_NODE_LOCAL_WEIGHT_MISSING: '当前机器还没有使用比例，请刷新后重试。',
        EXECUTION_NODE_LEGACY_WEIGHT_MISSING: '已有账号缺少使用比例，请刷新后重试。',
        EXECUTION_NODE_LOCAL_PROXY_MISMATCH: '当前机器的连接信息不一致，请重新准备。',
        EXECUTION_NODE_LEGACY_PROXY_MISMATCH: '已有账号的连接信息不一致，请重新准备。',
        EXECUTION_NODE_PAIRING_NOT_READY: '两台机器还没有连接完成。',
        EXECUTION_NODE_PREFLIGHT_UNAVAILABLE: '连接检查暂时不可用，请稍后重试。',
        EXECUTION_NODE_PREFLIGHT_FAILED: '连接检查没有通过，请检查两台机器后重试。',
        EXECUTION_NODE_POLICY_UNAVAILABLE: '共同使用设置暂时不可用，请稍后重试。',
        EXECUTION_NODE_PROXY_REQUIRED: '机器还没有准备好访问方式，请先完成连接。',
        EXECUTION_NODE_PROXY_IMMUTABLE: '共同使用打开后不能直接修改机器访问方式。',
        DATABASE_UNAVAILABLE: '共享数据暂时不可用，请稍后重试。',
        SHARED_WEIGHTS_INVALID: '使用比例无效，请检查后重试。',
        SHARED_PROXY_MAPPING_INVALID: '机器连接信息无效，请先完成准备。',
        LOCAL_RUNTIME_DISABLED: '请先完成本机准备。',
        LOCAL_NODE_ID_INVALID: '本机识别失败，请重新准备本机。',
        LOCAL_DEFAULT_PROXY_MISSING: '本机还没有准备好，请先完成本机准备。',
        LOCAL_WEIGHT_MISSING: '当前机器还没有使用比例，请刷新后重试。',
        LOCAL_PROXY_MISMATCH: '当前机器的连接信息不一致，请重新准备。',
        LEGACY_OWNER_INVALID: '已有账号的连接信息不完整，请刷新后重试。',
        LEGACY_PROXY_MISMATCH: '已有账号的连接信息不一致，请重新准备。',
        POSITIVE_WEIGHT_MISSING: '至少要让一台机器的使用比例大于 0。',
        PROXY_MAPPING_INVALID: '机器连接信息不完整，请先完成准备。',
    ...
    settings: {
      ...
      features: {
        ...
        modelPricing: {
          title: '模型价格',
          description: '向已登录用户展示 XIASS 原有的模型价格、分组倍率和人民币计费预览。默认开启。',
        ...
        availableChannels: {
          ...
          configureLink: '前往 渠道管理 > 渠道定价 配置模型渠道',
          enabled: '启用模型渠道',
          enabledHint: '关闭后用户端模型渠道入口隐藏，接口返回空数组；模型价格可单独保持开启。',
        },
        riskControl: {
          title: '风控中心',
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 XIASS API 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 XIASS API 用户登录',
      ...
      scheduling: {
        ...
        executionNodeBalancing: '两台机器共同使用账号',
        executionNodeBalancingHint: '连接完成后，客户无需修改地址和 Key，新请求会按比例使用两台机器上的账号。',
        executionNodePanelHint: '连接两台机器、查看状态、设置使用比例和断线接管，都在这里完成。',
        openExecutionNodePanel: '打开连接页面',
      ...
      upstreamBillingProbe: {
        title: '上游倍率自动探测',
        description: '定期获取 API Key 账号所连接兼容上游网关声明的计费倍率；只有另行开启“同步上游声明倍率”的账号才会更新账号倍率。',
        enabled: '启用全局自动探测',
      ...
      gatewayForwarding: {
        ...
        grokCrossClientMapHint: '默认开启。关闭后，GPT、Codex、o 系列和 Claude 模型 ID 不会静默改写为默认 Grok 文本模型。',
        grokDefaultBaseURLMode: '默认 Grok 上游',
        grokDefaultBaseURLModeHint: '仅用于 Grok 账号未显式启用自定义 base URL 的文本请求；媒体和语音仍使用各自的官方 API 主机。',
      ...
      site: {
        ...
        teamChildCreation: '显示 Team 子号创建',
        teamChildCreationHint: '默认隐藏账号管理入口。启用前必须先导入有效的 Cloudflare 邮箱配置。'
      },
      purchase: {
        title: '充值/订阅页面',
      ...
      payment: {
        ...
        rechargeBonusCampaign: '充值赠送活动',
        rechargeBonusCampaignHint: '关闭后新充值订单不再额外赠送，现有充值倍率仍照常生效；规则调整只影响之后新创建的订单。',
        rechargeBonusThreshold: '充值满',
        rechargeBonusGift: '元，赠送',
        rechargeBonusUnit: '元',
        rechargeBonusAdd: '添加赠送规则',
        rechargeBonusRemove: '删除赠送规则',
        orderTimeout: '订单超时时间',
        ...
        easypayCustomMethodsHint: '添加当前易支付服务商额外支持的支付方式。支付方式会记录到 XIASS API 订单中，上游 type 会作为易支付 type 参数提交。',
