export default {
    accounts: {
      ...
      pelicanBenchmark: {
        ...
        status: { queued: '排队中', running: '测试中', canceling: '停止中', succeeded: '已完成', failed: '失败', canceled: '已停止', interrupted: '已中断' },
      ...
      executionNodeTakeoverBadge: '已接管',
      ...
      executionNodeTakeoverRequired: '{node} 已离线，请先开启容灾接管后再管理',
