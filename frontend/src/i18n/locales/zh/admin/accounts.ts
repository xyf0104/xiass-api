export default {
    ...
    autoResetCredit: {
      ...
      codexTicket: {
        ...
        captureProxyHint: '这里只选择本次 Ticket 抓取使用的代理，不会修改账号业务绑定。',
        accountDefault: '账号绑定默认',
        accountDefaultHint: '不传 proxy_ids，沿用后端原有绑定策略',
        allActive: '所有活动节点',
        allActiveHint: '使用当前全部活动代理进行抓取',
        customProxies: '自定义节点',
        customProxiesHint: '按来源和搜索结果选择抓取出口',
        accountDefaultSummary: '本账号当前可见绑定出口 {count} 个；实际抓取仍由后端默认策略决定。',
        ...
        invert: '反选当前',
        clear: '清空',
        proxySelectionSummary: '本次将显式传入 {count} 个 proxy_ids。',
        ...
        observedModel: '实际模型',
        egress: '票据来源出口',
        egressHint: '票据按账号和模型共享，这里仅记录抓取来源；业务请求仍由该账号的全部代理出口正常负载均衡使用。',
        latency: '探测延迟',
