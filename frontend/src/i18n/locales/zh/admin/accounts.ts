export default {
    accounts: {
      ...
      pelicanBenchmark: {
        title: '鹈鹕测智',
        selectAll: '全选', startSelected: '测试已选 ({count})', filter: '测试结果筛选', allResults: '全部', passed: '测试通过',
        continue: '继续', retry: '重试', busy: '正在处理，请稍候…', waitingForExit: '正在停止同账号任务，等待完全退出后启动…',
        tabs: { new: '新建测试', current: '当前测试', history: '测试记录' },
        name: '账号名称', plan: '套餐', statusLabel: '状态', model: '模型', date: '测试日期', duration: '耗时', result: '操作 / 结果',
        count: '共 {count} 项', seconds: '{seconds} 秒',
        startAll: '全部启动', start: '启动测试', stopAll: '全部停止', stop: '停止测试',
        refresh: '刷新', details: '查看详情', collapse: '收起详情', preview: '测试结果预览', previous: '上一页', next: '下一页',
        unavailable: '账号不可测试、已有任务或未支持所选模型',
        empty: { new: '暂无可测试账号', current: '暂无当前测试', history: '暂无测试记录' },
        status: { queued: '正在启动', running: '测试中', canceling: '停止中，待退出', succeeded: '已完成', failed: '失败', canceled: '已停止', interrupted: '已中断' },
        skipped: '已跳过 {count} 个不可测试或已有任务的账号，其余请求已提交。',
        partialStart: '部分测试已提交，后续请求未确认。请刷新当前测试核对，已提交任务仍可停止。',
        modelsFailed: '加载账号模型失败，请重新打开模型选项。',
        errors: {
          upstream_client_upgrade_required: '上游要求升级 Codex 客户端，请更新兼容配置后重试',
          continuation_source_unavailable: '原测试记录暂不可读取，请稍后重试',
          invalid_continuation_source: '原测试记录不能继续，请重新创建测试',
          upstream_http_400: '上游无法接受测试请求，请检查模型支持后重试',
          upstream_http_401: '账号授权已失效，请重新授权后重试',
          upstream_http_403: '上游拒绝访问，请检查账号权限',
          upstream_http_404: '上游模型或服务不存在，请检查模型设置',
          upstream_http_408: '上游请求超时，请稍后重试',
          upstream_http_429: '上游请求过于频繁或额度不足，请稍后重试',
          upstream_http_500: '上游服务异常，请稍后重试',
          upstream_http_502: '上游网关异常，请稍后重试',
          upstream_http_503: '上游服务暂时不可用，请稍后重试',
          upstream_http_504: '上游网关超时，请稍后重试',
          upstream_network_error: '连接上游失败，请检查网络后重试',
          upstream_stream_error: '上游流式响应失败或中断',
          no_upstream_detail: '未取得可安全展示的上游错误正文',
          upstream_incomplete: '上游响应未完成，请继续或重试',
          account_unavailable: '账号不可用', ineligible: '该账号不支持此测试', free_plan: '免费账号不参与测试', unknown_plan: '套餐信息未确认',
          unsupported_auth_mode: '该授权方式暂不支持测试', model_not_supported: '账号不支持所选模型', fixed_egress_unavailable: '账号固定出口不可用',
          upstream_failed: '上游测试失败', html_too_large: '生成结果超过大小限制', invalid_html: '未返回完整 HTML', timeout: '测试超时',
          runner_interrupted: '测试已中断', runner_panic: '测试执行异常', account_access_denied: '无账号管理权限', account_not_found: '账号不存在', unknown: '测试未完成'
        },
        notConnected: '鹈鹕测智服务尚未接入，请接入后刷新。',
        loadFailed: '加载测试数据失败，请刷新重试。',
        startFailed: '启动请求未确认，请刷新当前测试后重试。',
        stopFailed: '停止请求未确认，请刷新当前测试后重试。',
        stopWaitTimeout: '停止等待已达 30 秒，原任务尚未确认退出，未创建新测试。你仍可停止原任务，或刷新后重试。',
        resultFailed: '结果预览加载失败，请收起后重新打开。'
      },
      autoRefresh: '自动刷新',
      ...
      dataExported: '数据导出成功',
      dataExportedSkippedShadows: '数据已导出。已跳过 {count} 个关联凭据账号（Spark 影子或 OAuth 副本）：其调度配置不在备份内，还原后需重新创建并调优。',
      ...
      allPlatforms: '全部平台',
      allTypes: '全部类型',
      allSubscriptionPlans: '全部订阅档位',
      teamBusinessPlan: 'Team / Business',
      otherUnknownPlan: '其他 / 未知档位',
      allLoginMethods: '全部登录方式',
      password2FALogin: '密码 + 2FA',
      emailCodeLogin: '邮箱验证码',
      loginMethodUnconfigured: '登录资料未完整保存',
      allStatus: '全部状态',
      allGroups: '全部分组',
      executionNodeAll: '全部归属',
      executionNodeLocal: '本机',
      executionNodeReadOnlyBadge: '只读',
      executionNodeManageableBadge: '可管理',
      executionNodePairingUnavailable: '节点配对不可用，账号写操作已暂停',
      executionNodeBulkExcluded: '已排除 {count} 个远程只读账号。',
      executionNodeBulkRemoteReadOnly: '当前筛选的是远程只读账号，不能执行批量修改。',
      executionNodeRemoteReadOnly: '{node} 账号由 {node} 管理，当前仅可查看',
      executionNodeRemoteUnavailable: '远程账号状态未确认，当前仅可查看',
      ...
      upstreamBilling: {
        trustWarning: '此倍率由上游站点针对当前 API Key 自行声明。XIASS API 无法验证该值是否与实际扣费一致；上游站点或中间代理可能返回伪造、过期或被篡改的数据。请结合账单、余额变化和实际用量自行核验。',
      ...
      usageWindow: {
        ...
        grokRequests: '请求',
        grokTokens: 'Token',
        grokFreeQuota24hHint: '按 XIASS API 近 24 小时本地 Token 用量估算（上限 {limit}）',
      ...
      duplicateOAuthSuccess: '账号已复制为「{name}」，与原账号共享 OAuth 凭据并已继承调度状态',
      ...
      syncUpstreamModelsMappingFallback: '上游 /models 接口不可用，已按账号现有的具体模型映射同步能力。',
      syncUpstreamModelsMetadataPartial: '已保存部分模型的能力信息；其余模型能力仍不完整，将继续使用安全的保守配置。',
      syncUpstreamModelsMetadataIncomplete: '模型 ID 已同步，但未获得可验证的完整能力信息；现有能力快照未被覆盖。',
      syncUpstreamModelsMetadataTooLarge: '上游模型能力信息超过安全存储限制，已保留原有能力快照。',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个兼容网关的场景。',
    ...
    autoResetCredit: {
      title: '自动使用 OpenAI 重置卡',
      consent: '默认关闭。开启后可自动消耗已有重置卡，不购买新卡。关闭仅阻止新兑换，已发出的兑换仍会等待结果。',
      threshold5h: '5h 用量阈值 (%)',
      threshold7d: '7d 用量阈值 (%)',
      pending: '兑换进行中或结果未确认，已阻止重复消费；关闭、刷新或恢复状态不会解锁。若等待后仍未恢复，需管理员核对官方兑换记录后处理。',
      cooldown: '兑换冷却中，请稍后重试（最多一分钟）。这不是结果待核对锁。',
      save: '保存自动 Reset 设置',
      saved: '自动 Reset 设置已保存',
      loadFailed: '无法读取设置或当前节点无管理权限，自动 Reset 保持不可编辑。',
      saveFailed: '设置保存失败，请重新读取确认。',
      invalidThreshold: '用量阈值必须为 0.1% 至 100%。'
    },
      ...
      noProxy: '无代理',
		multiProxy: {
			singleMode: '单代理',
			multiMode: '多出口',
			configured: '已配置 {count} 个出口',
			distributionMode: '出口策略',
			balancedMode: '均衡分发',
			adaptiveMode: '首字优先',
			totalCapacity: '总容量 {count}',
			proxyCapacity: '{name} 并发上限',
			routePriorityFor: '{name} 线路优先级',
			routePriorityShort: '线路优先级',
			slots: '并发',
			missingProxy: '代理 #{id} 已删除或不可见',
			remove: '移除出口'
		},
      systemManagedProxy: '系统节点出口',
      systemManagedProxyAuto: '自动绑定',
      systemManagedProxyHint: '账号归属 {node}，当前默认使用该节点私有出口；也可以手动切换代理，切换不会改变账号归属。',
      concurrency: '并发数',
      loadFactor: '负载因子',
      ...
      viewStats: '查看统计',
      codexTicket: {
        viewStatus: '查看 Codex Ticket',
        title: '账号 Codex Ticket',
        redactedNotice: '仅显示脱敏状态，不显示原始票据',
        accountEnabled: '启用此账号的票据抓取',
        enabledHint: '已启用：该账号可以抓取、自动更新并使用票据。',
        disabledHint: '默认关闭。启用后才会针对该账号抓取和使用票据。',
        toggleFailed: '更新账号票据开关失败，请稍后重试。',
        captureProxyTitle: '抓取出口',
        captureProxyHint: '点击抓取会保存本次选择，后续手动和自动抓取沿用。业务出口不变。',
        accountDefault: '自动抓取默认',
        accountDefaultHint: '使用已保存的抓取出口；未配置时沿用业务绑定默认策略',
        allActive: '所有活动节点',
        allActiveHint: '使用当前全部活动代理进行抓取',
        customProxies: '自定义节点',
        customProxiesHint: '按来源和搜索结果选择抓取出口',
        accountDefaultSummary: '未保存专用出口，自动抓取沿用业务绑定默认策略（当前绑定 {count} 个）。',
        savedDefaultSummary: '已保存 {count} 个自动抓取出口。',
        savedUnknownWarning: '其中 {count} 个已删除或当前不可见，仅按 ID 保留。',
        missingProxy: '出口 ID {id} 已删除或当前不可见，仍保留选择；取消勾选后才会移除。',
        followBusiness: '恢复业务出口',
        saveCaptureDefaults: '仅保存选择',
        savingCaptureDefaults: '保存中...',
        captureDefaultsSaveFailed: '保存自动抓取出口失败，请稍后重试。',
        searchProxies: '搜索代理、地址或来源',
        allSources: '全部来源',
        manualSource: '手动代理',
        selectAll: '全选当前',
        invert: '反选当前',
        clear: '清空',
        proxySelectionSummary: '已选择 {count} 个抓取出口。',
        proxyLoadFailed: '加载抓取代理失败，请稍后重试。',
        ready: '已抓取（本地有效）',
        unavailable: '未获取或已过期',
        length: '长度 / 原版参考',
        shapeValid: '符合原版参考结构',
        ...
        expiresAt: '本地预计到期',
        remaining: '剩余时间',
        remainingHours: '{hours} 小时 {minutes} 分钟',
        remainingMinutes: '{minutes} 分钟',
        observedModel: '抓取时返回模型',
        egress: '票据来源出口',
        egressHint: '同一账号和模型的票据仍通过已配置的业务出口发送。抓取成功不代表这些出口复用成功，业务实际返回模型以请求日志为准。',
        latency: '探测延迟',
        fallbackHint: '未找到目标模型，当前使用最快的 {model} 票据作为回退。',
        refresh: '重新抓取',
        refreshing: '抓取中...',
        refreshFailed: '重新抓取失败，请稍后重试。',
        probeDetails: '查看全部出口（{count}）',
        unknownEgress: '未知出口',
        blockedHint: '当前“失败即阻断”策略会阻止没有有效票据的请求。',
        noStatus: '没有可展示的票据状态。该账号可能尚未采集过，或不属于 Codex OAuth 账号。',
        storageHint: '原始票据保存在账号的服务端受保护数据中，仅用于转发和刷新；账号导出、编辑和管理界面都不会返回原始内容。'
      },
