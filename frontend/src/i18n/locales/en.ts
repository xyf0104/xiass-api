export default {
  ...
  usage: {
    ...
    endTime: 'End time',
    applyTimeRange: 'Query',
    invalidMinuteRange: 'Select a valid minute-level range with the start time before the end time',
    requestCount: 'Requests',
    modelBillingDetails: 'Model billing details',
    backToUsers: 'Back to users',
    user: 'User',
    noBillingDetails: 'No billing records in the selected range',
    billingDetailsFailed: 'Failed to load billing details',
    resetNow: 'Now',
  ...
  admin: {
    executionNodes: {
      title: 'Dual-node load balancing',
      description: 'Manage shared account scheduling and fixed node egress. Disabled by default until shared-state and egress checks pass.',
      pairingTitle: 'Web pairing',
      pairingDescription: 'Use a one-time invite to authenticate the peer and verify that both instances share PostgreSQL, Redis, and authentication keys. Pairing never transfers account credentials or database passwords.',
      pairingReady: 'Production cluster ready',
      pairingIncomplete: 'Peer recorded; state mismatch remains',
      pairingNotPaired: 'Not paired',
      inviteTitle: 'Generate an invite here',
      inviteHint: 'The invite expires in 10 minutes and can be used once. Send it to the other XIASS administrator over a secure channel.',
      ...
      joinTitle: 'Connect another XIASS',
      joinHint: 'Enter the peer XIASS HTTPS URL and the one-time invite generated by that peer.',
      peerURL: 'Peer URL',
      ...
      passed: 'Match',
      failed: 'Mismatch',
      pairingReadyHint: 'Both instances read the same accounts, keys, balances, billing, and heartbeat state. Account management shows the complete shared pool and each account owner node.',
      pairingMismatchHint: 'The instances can communicate, but shared state is not ready. Point both at the same PostgreSQL, Redis, and authentication keys, then pair again. XIASS will not force-merge independent ledgers.',
      pairingLoadFailed: 'Failed to load pairing status',
      pairingFailed: 'Node pairing failed',
      inviteGenerated: 'One-time invite generated',
      inviteCopied: 'Invite copied',
      inviteCopyFailed: 'Could not copy invite',
      pairSuccess: 'Node pairing verified',
      unpairSuccess: 'Local pairing record removed',
      confirmUnpairTitle: 'Confirm node unpairing',
      confirmUnpairMessage: 'Unpairing removes only this instance peer record. It does not delete accounts, keys, billing, or shared data. Disable multi-node scheduling first when possible.',
      confirmUnpair: 'Unpair',
      refresh: 'Refresh status',
      saving: 'Saving...',
      save: 'Save configuration',
      enabled: 'Enable dual-node account scheduling',
      enabledHint: 'New sessions use node weights within the highest account-priority tier; existing sticky sessions are not forcibly migrated.',
      on: 'Enabled',
      off: 'Disabled',
      ...
      nodesTitle: 'Execution nodes and account pool',
      node: 'Node',
      online: 'Online',
      offline: 'Offline',
      local: 'Local',
      weight: 'Account weight',
      weightHint: 'Weights apply only within the highest account-priority tier; 0 drains new sessions from that node.',
      egress: 'Node upstream egress',
      egressHint: 'An account normally reaches its provider through the proxy or public egress bound to its owner node. This is neither the customer Base URL nor public ingress weighting.',
      ...
      ingressTitle: 'Public ingress note',
      ingressDescription: 'This panel controls shared account-pool node weights, not which server receives a customer connection first. Public traffic splitting between the primary and secondary domains belongs in Caddy, Cloudflare Load Balancing, or another ingress layer using /readyz for health checks.',
      canEnable: 'Preflight passed; ready to enable',
      cannotEnable: 'Cannot enable yet',
      confirmEnableTitle: 'Confirm dual-node scheduling',
      confirmEnableMessage: 'Enabling will assign legacy accounts that have no node owner and start using the shared account pool. Confirm that both machines use the same PostgreSQL, Redis, and fixed egress setup.',
      confirmEnable: 'Enable',
      issueTitle: 'Issues to resolve',
      statusTitle: 'Current status',
      noIssues: 'No configuration issues detected.',
      reloadFailed: 'Failed to load load-balancing status',
      saveSuccess: 'Load-balancing configuration saved',
      saveFailed: 'Failed to save load-balancing configuration',
      invalidWeights: 'Node IDs must be unique; weights must be finite numbers from 0 to 1000000, with at least one positive weight.',
      invalidProxy: 'When enabled, every node must use a different valid fixed egress.',
      issues: {
        MULTI_NODE_DISABLED: 'Multi-node routing is disabled; this server is operating normally in single-node mode.',
        EXECUTION_NODE_LOCAL_CONFIG_DISABLED: 'Enable the local multi-node runtime in the deployment configuration and restart XIASS before enabling account scheduling.',
        EXECUTION_NODE_PROXY_MAPPING_INCOMPLETE: 'The node egress mapping is incomplete. Configure a separate active fixed egress for every node.',
        EXECUTION_NODE_PROXY_MAPPING_DUPLICATE_PROXY: 'A fixed egress cannot be reused by multiple nodes.',
        EXECUTION_NODE_PROXY_MAPPING_UNKNOWN_NODE: 'The fixed egress mapping contains an unknown node.',
        EXECUTION_NODE_PROXY_MAPPING_UNAVAILABLE: 'The active node egress mapping is invalid. Repair it before saving.',
        INVALID_EXECUTION_NODE_PROXY_IDS: 'The node egress configuration is invalid. Check the selected proxies.',
        EXECUTION_NODE_LEGACY_PROXY_INVALID: 'The legacy account default egress is missing, inactive, or expired.',
        EXECUTION_NODE_LOCAL_WEIGHT_MISSING: 'The shared weights do not contain the current server node.',
        EXECUTION_NODE_LEGACY_WEIGHT_MISSING: 'The shared weights do not contain the legacy account owner node.',
        EXECUTION_NODE_LOCAL_PROXY_MISMATCH: 'The local default egress does not match the shared mapping.',
        EXECUTION_NODE_LEGACY_PROXY_MISMATCH: 'The legacy default egress does not match the shared mapping.',
        EXECUTION_NODE_PAIRING_NOT_READY: 'The two XIASS instances have not completed production-ready pairing and shared-state verification.',
        EXECUTION_NODE_PREFLIGHT_UNAVAILABLE: 'The node account preflight service is unavailable. Check the database, Redis, and account repository.',
        EXECUTION_NODE_PREFLIGHT_FAILED: 'The node account preflight failed. Check account ownership, fixed egress, and shared state.',
        EXECUTION_NODE_POLICY_UNAVAILABLE: 'The shared execution-node policy is unavailable. Try again later.',
        EXECUTION_NODE_PROXY_REQUIRED: 'Every account must retain a fixed egress while multi-node scheduling is enabled.',
        EXECUTION_NODE_PROXY_IMMUTABLE: 'An account fixed egress cannot be changed while multi-node scheduling is enabled.',
        DATABASE_UNAVAILABLE: 'The shared settings database is unavailable.',
        SHARED_WEIGHTS_INVALID: 'The shared node weights are invalid.',
        SHARED_PROXY_MAPPING_INVALID: 'The shared node-to-egress mapping is invalid.',
        LOCAL_RUNTIME_DISABLED: 'Multi-node runtime is disabled on this server. Configure the local deployment first.',
        LOCAL_NODE_ID_INVALID: 'The local node ID is missing or invalid.',
        LOCAL_DEFAULT_PROXY_MISSING: 'The local default egress proxy is not configured.',
        LOCAL_WEIGHT_MISSING: 'The shared weights do not contain this server node ID.',
        LOCAL_PROXY_MISMATCH: 'The shared egress mapping does not match this server default proxy.',
        LEGACY_OWNER_INVALID: 'The legacy account owner and egress proxy are incomplete.',
        LEGACY_PROXY_MISMATCH: 'The legacy account egress does not match the deployment configuration.',
        POSITIVE_WEIGHT_MISSING: 'At least one node must have a positive weight.',
        PROXY_MAPPING_INVALID: 'The node-to-egress mapping is incomplete or duplicated.',
        NODE_PROXY_UNAVAILABLE: 'A node has no active fixed egress proxy.',
        NODE_OFFLINE: 'A configured execution node is offline.',
        HEARTBEAT_STORE_UNAVAILABLE: 'Redis heartbeat state is unavailable.',
        PROXY_STATUS_UNAVAILABLE: 'Could not read fixed egress status.',
        PAIRING_NOT_READY: 'Production-ready node pairing and shared-state verification are incomplete.',
        ACCOUNT_STATS_UNAVAILABLE: 'Could not read per-node account statistics.'
      }
    },
    // Dashboard
    dashboard: {
    ...
    users: {
      ...
      groupConfigHint: 'Configure available groups and custom rates for {email}',
      exclusiveGroups: 'Exclusive Groups',
      publicGroups: 'Public Groups (Can Be Hidden Per User)',
    ...
    groups: {
      ...
      accountsTotal: 'Total:',
      accountsUnit: '',
      userAccountAllowlist: {
        title: 'User Callable Accounts',
        runtimeTitle: 'Users Currently Calling',
        runtimeAvailableAccounts: '{count} normal schedulable accounts in this group',
        chooseGroup: 'Choose the group whose current users you want to view and configure.',
        noAccountGroups: 'This account is not currently associated with a configurable group.',
        noRuntimeUsers: 'No user is currently using this group.',
        noUsersForAccount: 'No user is currently using the selected account.',
        user: 'User',
        currentAccounts: 'Accounts in Use',
        ...
        noSchedulableAccounts: 'This group has no normal schedulable accounts.',
        allow: 'Allow',
        account: 'Account',
        status: 'Status',
        ...
        normal: 'Normal',
        allowed: 'Allowed',
        requireOneAccount: 'Keep at least one account; saving an all-deny rule is not allowed.',
        restoreOriginal: 'Restore Original Scheduling',
        configure: 'Configure',
        saved: 'User callable accounts saved',
        restored: 'Original group scheduling restored',
        loadFailed: 'Failed to load user callable accounts',
        saveFailed: 'Failed to save user callable accounts',
        restoreFailed: 'Failed to restore original group scheduling'
      },
      ...
      modelRouting: {
        title: 'Model Routing Preference',
        tooltip: 'Prefer selected accounts for a model. OpenAI groups can also prefer account pools. Normal scheduling is used when the preferred range is unavailable. A trailing * wildcard is supported.',
        enabled: 'Enabled',
        disabled: 'Disabled',
        disabledHint: 'Routing rules will only take effect when enabled',
        addRule: 'Add Routing Rule',
        modelPattern: 'Model Pattern',
        modelPatternPlaceholder: 'gpt-5.6-luna or claude-opus-*',
        modelPatternHint: 'Supports a trailing * wildcard, such as gpt-5.6-*',
        ...
        noRulesHint: 'Add a rule to prefer accounts or pools for a model',
        searchAccountPlaceholder: 'Search accounts...',
        accountsHint: 'Select multiple accounts; normal priority, health, and concurrency still apply inside this range',
        pools: 'Preferred Pools',
        loadingPools: 'Loading account pools...',
        noPools: 'No account pools. Create one in account management first.',
        poolsHint: 'Select multiple pools; membership changes take effect automatically'
      },
      mcpXml: {
    ...
    riskControl: {
      ...
      blockedKeywordsPlaceholder: 'One rule per line, e.g.:\nreverse engineer && website\ncontains:badword',
      ...
      blockedKeywordsContextHint: 'Prefer contextual rules such as "term A && term B". A bare term matches the complete input only; use contains:term only when substring matching is intentional.',
    ...
    accounts: {
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by XIASS API, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within XIASS API.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another XIASS API instance.',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to XIASS API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">XIASS API is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of XIASS API, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to XIASS API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the XIASS API AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Recharge conversion: pay 1 {currency}, base credit CNY {balance}',
