<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/当前版本-v1.0.74-0ea5e9" alt="当前版本 v1.0.74" />
...
v1.0.74 增强历史运行时迁移：旧 NoWind 安装会保留原 Git `origin`，使用独立的 `xiass-upstream` 获取 XIASS API 正式更新；旧数据库、数据目录、环境变量、软路由节点和端口配置仍可原地升级，不需要重新初始化。
