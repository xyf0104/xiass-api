<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/当前版本-v1.2.2-0ea5e9" alt="当前版本 v1.2.2" />
...
- 管理员批量添加已有 OpenAI OAuth 账号，最多三个独立授权窗口并行；邮箱、密码和 2FA 登录信息加密保存，兼容既有 401 重新授权。
...
5. 授权成功后读取并核验实际账号配置；邮箱、密码和 2FA 密钥通过专用加密字段保存。401 时可复用原“一键重新授权”，更新原账号，不另建账号。敏感信息不进入普通账号列表、审计正文或导出文件。
