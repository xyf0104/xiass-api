<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/当前版本-v1.0.77-0ea5e9" alt="当前版本 v1.0.77" />
...
v1.0.77 修复网页在线更新的提前刷新：容器更新任务被接收后，页面会持续检测目标版本；只有新容器恢复并返回新版本时才提示成功和刷新，避免更新期间跳转到 502 页面。
