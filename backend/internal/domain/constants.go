...
const (
	...
	AntigravityGemini38FlashTieredModel = "gemini-3.8-flash-tiered"
)
...
var DefaultAntigravityModelMapping = map[string]string{
	...
	// Gemini 3.8 follows the same XIASS public three-tier contract. Runtime
	// routing rewrites these identities to AntigravityGemini38FlashTieredModel.
