...
func TestBuildCodexModelsManifestForGroupUsesSyncedAccountMetadata(t *testing.T) {
	...
	account.SetUpstreamModelMetadataSnapshot(UpstreamModelMetadataSnapshot{
		...
		Models: map[string]UpstreamModelMetadata{
			"x-preview-f-free": {
				ID: "x-preview-f-free", DisplayName: "Ox Alpha Free (Unlimited)",
				Description: "Stealth reasoning model", Reasoning: &reasoning,
				SupportedReasoningLevels: []string{"low", "high", "max"},
