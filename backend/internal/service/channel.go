...
type ChannelModelPricing struct {
	...
	InputPrice                   *float64          `json:"input_price"` // base: USD/token; final: RMB/token
...
func normalizeLegacyPricingJSON(data []byte, keys map[string]string) ([]byte, error) {
	...
	for legacy, canonical := range keys {
...
// UnmarshalJSON accepts both the current snake_case representation and the
// CamelCase JSON stored by older XIASS releases. RawMessage remapping keeps
// explicit zero and null values intact.
func (p *ChannelModelPricing) UnmarshalJSON(data []byte) error {
	normalized, err := normalizeLegacyPricingJSON(data, map[string]string{
		"ID": "id", "ChannelID": "channel_id", "Platform": "platform", "Models": "models",
		"BillingMode": "billing_mode", "PriceMode": "price_mode", "InputPrice": "input_price",
		"OutputPrice": "output_price", "CacheWritePrice": "cache_write_price",
		"CacheWrite1hPrice": "cache_write_1h_price", "CacheReadPrice": "cache_read_price",
		"FastMultiplier": "fast_multiplier", "FlexMultiplier": "flex_multiplier",
		"MaxReasoningEffortMultiplier": "max_reasoning_effort_multiplier",
		"ImageInputPrice":              "image_input_price", "ImageOutputPrice": "image_output_price",
		"PerRequestPrice": "per_request_price", "Intervals": "intervals",
		"CreatedAt": "created_at", "UpdatedAt": "updated_at",
	})
	if err != nil {
		return err
	}
	type pricingAlias ChannelModelPricing
	var decoded pricingAlias
...
func (p *PricingInterval) UnmarshalJSON(data []byte) error {
	normalized, err := normalizeLegacyPricingJSON(data, map[string]string{
		"ID": "id", "PricingID": "pricing_id", "MinTokens": "min_tokens",
		"MaxTokens": "max_tokens", "TierLabel": "tier_label", "InputPrice": "input_price",
		"OutputPrice": "output_price", "CacheWritePrice": "cache_write_price",
		"CacheWrite1hPrice": "cache_write_1h_price", "CacheReadPrice": "cache_read_price",
		"InputMultiplier": "input_multiplier", "OutputMultiplier": "output_multiplier",
		"CacheWriteMultiplier": "cache_write_multiplier", "CacheReadMultiplier": "cache_read_multiplier",
		"PerRequestPrice": "per_request_price", "SortOrder": "sort_order",
		"CreatedAt": "created_at", "UpdatedAt": "updated_at",
	})
	if err != nil {
		return err
	}
	type intervalAlias PricingInterval
	var decoded intervalAlias
	if err := json.Unmarshal(normalized, &decoded); err != nil {
		return err
	}
	*p = PricingInterval(decoded)
	return nil
}
