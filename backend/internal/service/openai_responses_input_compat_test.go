...
func TestOpenAIGatewayService_OAuthPreservesPreviousResponseToolContinuation(t *testing.T) {
	...
	require.Equal(t, "call_missing", gjson.GetBytes(upstream.bodies[0], "input.0.call_id").String())
}
