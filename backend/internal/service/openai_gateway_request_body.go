...
// IsOpenAIResponsesCompactPath reports whether a request targets the legacy
// /responses/compact endpoint, including forwardable subpaths.
...
//   - UserIDs, when present, filters by the trusted XIASS API user that owns the API key
