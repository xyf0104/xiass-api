...
// XIASS only persists temporary scheduling blocks for explicit proxy
// authentication failures. Connectivity errors fail over the current request
// but remain immediately schedulable after the network recovers.
