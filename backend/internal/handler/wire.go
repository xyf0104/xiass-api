...
func ProvideAdminHandlers(
	...
	softRouterProxyHandler *admin.SoftRouterProxyHandler,
	...
	accountHandler.SetCodexTicketRefresher(openAIGatewayService)
	return &AdminHandlers{
		...
		Proxy:                  proxyHandler,
		SoftRouterProxy:        softRouterProxyHandler,
...
func ProvideAdminGroupHandler(
	...
	h.SetUserGroupAccountAllowlistService(allowlistService)
	return h
}
