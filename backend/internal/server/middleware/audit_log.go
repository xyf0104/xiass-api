...
var auditExtraAllowedKeys = map[string]struct{}{
	...
	"account_id": {}, "reauthorization_number": {}, "cooldown_until": {},
}
...
var auditBodyOmittedRoutes = map[string]struct{}{
	"POST /api/v1/admin/proxies/subscriptions/preview":                   {},
	"PUT /api/v1/admin/proxies/subscriptions":                            {},
	"POST /api/v1/admin/openai/batch-oauth/tasks":                        {},
	"POST /api/v1/admin/openai/batch-oauth/tasks/:task_id/restart":       {},
	...
	"POST /api/v1/admin/settings/sms-receiver/card-keys":                 {},
