...
func TestAnthropicEventToResponses_ThinkingAfterTextKeepsMessageOutput_UpstreamCoverage(t *testing.T) {
...
func TestAnthropicEventToResponses_MultipleTextBlocksAdvanceContentIndex_UpstreamCoverage(t *testing.T) {
	state := NewAnthropicEventToResponsesState()
	state.Model = "claude-sonnet-4-5"
...
func TestAnthropicEventToResponses_ItemLifecycleIsBalanced_UpstreamCoverage(t *testing.T) {
