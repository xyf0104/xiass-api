...
func provideCleanup(
	...
	proxySubscriptions *service.ProxySubscriptionService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"ProxySubscriptionService", func() error {
				if proxySubscriptions != nil {
					proxySubscriptions.Stop()
				}
				return nil
			}},
