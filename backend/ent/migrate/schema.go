...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "model_routing_pools", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		...
		{Name: "cost_ratio", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
