...
const (
	...
	// FieldModelRoutingPools holds the string denoting the model_routing_pools field in the database.
	FieldModelRoutingPools = "model_routing_pools"
...
var (
	...
	DefaultModelPricing jsontext.Value
