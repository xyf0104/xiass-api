module github.com/xyf0104/xiass-proxy-agent

go 1.26.0

require github.com/gylive/ccodex-sleep-state v0.0.0
...
replace github.com/gylive/ccodex-sleep-state => ./third_party/ccodex-sleep-state
